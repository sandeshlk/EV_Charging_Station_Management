...
$sql = "SELECT S.S_NAME,C.C_NAME,L.ADDRESS,L.CITY,L.LINK,FE.NO_OF_SLOTS,FE.FAST_SLOW,FE.COST_PER_UNIT,S.TIMING_OPEN,S.TIMING_CLOSE FROM COMPANY C,STATION S,LOCATION L,FEATURES FE WHERE S.S_ID=L.S_ID AND L.S_ID=FE.S_ID AND S.C_ID=C.C_ID HAVING CITY='HYGERABAD';;";
